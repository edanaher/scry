...
test_instances = [
   ...
   Instance(
        ...
        {'scry': {((None,), (None,)): {'users': {((None,), (('id', 2),)): {'favorites': {((None,), (('user_id', 2), ('book_id', 4))): {'books': {((None,), (('id', 4),)): {'series_books': {((None,), (None,)): {'series': {((('name', 'Harry Potter'),), (('id', 2),)): {}}}}, 'authors': {((('name', 'J.K. Rowling'),), (('id', 2),)): {}}}}}, ((None,), (('user_id', 2), ('book_id', 6))): {'books': {((None,), (('id', 6),)): {'series_books': {((None,), (None,)): {'series': {((('name', None),), (('id', None),)): {}}}}, 'authors': {((('name', 'Ted Chiang'),), (('id', 3),)): {}}}}}}}, ((None,), (('id', 1),)): {'favorites': {((None,), (('user_id', 1), ('book_id', 4))): {'books': {((None,), (('id', 4),)): {'series_books': {((None,), (None,)): {'series': {((('name', 'Harry Potter'),), (('id', 2),)): {}}}}, 'authors': {((('name', 'J.K. Rowling'),), (('id', 2),)): {}}}}}, ((None,), (('user_id', 1), ('book_id', 5))): {'books': {((None,), (('id', 5),)): {'series_books': {((None,), (None,)): {'series': {((('name', 'Harry Potter'),), (('id', 2),)): {}}}}, 'authors': {((('name', 'J.K. Rowling'),), (('id', 2),)): {}}}}}}}, ((None,), (('id', 3),)): {'favorites': {((None,), (('user_id', None), ('book_id', None))): {'books': {((None,), (('id', None),)): {'series_books': {((None,), (None,)): {'series': {((('name', None),), (('id', None),)): {}}}}, 'authors': {((('name', None),), (('id', None),)): {}}}}}}}}}}},
        ['- scry.users.favorites.books.series_books.series.name: Harry Potter', '- scry.users.favorites.books.authors.name: J.K. Rowling', '- scry.users.favorites.books.series_books.series.name: None', '- scry.users.favorites.books.authors.name: Ted Chiang', '- scry.users.favorites.books.series_books.series.name: Harry Potter', '- scry.users.favorites.books.authors.name: J.K. Rowling', '- scry.users.favorites.books.series_books.series.name: Harry Potter', '- scry.users.favorites.books.authors.name: J.K. Rowling', '- scry.users.favorites.books.series_books.series.name: None', '- scry.users.favorites.books.authors.name: None']
        ),
   Instance(
